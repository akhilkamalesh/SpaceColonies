...
public class SpaceWindow {
    ...
    public SpaceWindow(ColonyCalculator colony) {
        ...
        // COLORS
        PLANET_COLORS[0] = new Color(165, 209, 232);
        PLANET_COLORS[1] = new Color(173, 147, 189);
        PLANET_COLORS[2] = new Color(102, 176, 174);
        PLANET_COLORS[3] = new Color(112, 148, 180);
        PLANET_COLORS[4] = new Color(127, 96, 147);
        PLANET_COLORS[5] = new Color(58, 124, 122);
        PLANET_COLORS[6] = new Color(49, 86, 119);
    ...
    /**
     * This method dequeues the Waiting Party at the front of the
     * RollerCoasterQueue
    ...
    /**
     * This method creates Circle shapes for each Waiting Party in the
     * RollerCoasterQueue queue and adds the circles to the partyCircles list
     * and
        ...
        for (int i = 0; i < queuedParties.length; i++) {
            ...
            switch (planetPreference) {
                ...
                case 2:
                    ...
                    break;
                case 3:
                    shape.setForegroundColor(PLANET_COLORS[3]);
                    shape.setBackgroundColor(Color.BLACK);
                    break;
                default:
     ...
     * calls
     * updateCircles to redraw the new waiting parties
     */
    ...
    private void updatePlanet() {
        ...
        this.planetShapes[0] = addPlanetShape(planetX, planetY, planetOff, 1);
        this.planetShapes[1] = addPlanetShape(planetX, planetY, planetOff, 2);
        this.planetShapes[2] = addPlanetShape(planetX, planetY, planetOff, 3);

        addPlanetFilled(planetX, planetY, planetOff, 1);
        addPlanetFilled(planetX, planetY, planetOff, 2);
        addPlanetFilled(planetX, planetY, planetOff, 3);
    }
    ...
    private Shape addPlanetShape(
        ...
        int planetOff,
        int planetIndex) {
        int planetOffValue = (planetIndex - 1) * planetOff;
    ...
    private void addPlanetFilled(
        ...
        Planet planetObject = colonyCalculator.planetByNumber(planetIndex);
    ...
    private void updatePlanetText() {
        ...
        textPlanet(planetShapes[0].getX(), planetY, 1);
        textPlanet(planetShapes[1].getX(), planetY, 2);
        textPlanet(planetShapes[2].getX(), planetY, 3);
    }
    ...
    private void textPlanet(int planetX, int planetY, int index) {
        Planet planetObject = colonyCalculator.planetByNumber(index);
